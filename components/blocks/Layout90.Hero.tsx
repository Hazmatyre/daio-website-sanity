...
export const Layout90 = (props: Layout90Props) => {
  ...
  return (
    <section className="px-[5%] py-16 md:pb-24 lg:pb-28">
      <div className="container max-w-xl grid grid-cols-1 items-start justify-between gap-x-12 gap-y-8 md:grid-cols-2 md:gap-x-12 md:gap-y-8 lg:gap-x-20">
        <h1 className="text-6xl font-serif font-bold leading-[1.2] md:text-6xl lg:text-8xl xl:text-10xl whitespace-pre-line tracking-normal">{heading}</h1>
        <div className="">
